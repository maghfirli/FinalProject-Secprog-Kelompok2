...
Mata Kuliah: Secure Programming
Kode Mata Kuliah: COMP6695001
Kelompok: Kelompok 2
MAGHFIRLI ALIF AL AYUBI
1. Pendahuluan
  Dokumen ini disusun sebagai bentuk laporan Final Project untuk memenuhi salah satu syarat kelulusan pada mata kuliah Secure Programming. Project ini dikerjakan oleh kami secara berkelompok dengan tujuan untuk menerapkan konsep-konsep keamanan dalam pengembangan aplikasi web.
  Melalui pengerjaan project ini, kami diharapkan mampu memahami pentingnya penerapan secure coding, pengelolaan autentikasi, serta perlindungan data pengguna dalam sebuah sistem aplikasi.
...
5. Implementasi Secure Programming
    ...
    2.	Input Validation
    Setiap input yang diberikan oleh pengguna divalidasi untuk mencegah terjadinya serangan seperti SQL Injection dan input berbahaya lainnya.
    3.	Keamanan Password
    Data password pengguna disimpan dalam bentuk hash guna menjaga kerahasiaan dan keamanan data pengguna.
    4.	Session Management
    Pengelolaan session dilakukan dengan memperhatikan aspek keamanan untuk mencegah terjadinya session hijacking.
...
https://github.com/maghfirli/FinalProject-Secprog-Kelompok2.git 
